...
The oven made of rocks is of course not nearly as effective as our modern-day ovens. But it might be the best the baker can do at the time. To produce a longer- lasting and more effective oven, the baker would need access to steel and advanced tools that may not yet exist. Even if the baker figured out how such a modern oven could work, it may not be worth his time or effort to figure out how to turn rock into iron, iron into steel, and then make an oven out of it. He is a baker, after all. But someone else could do it. And someone else did, because today we do have modern, highly effective ovens made from steel.

<!-- {"id": "05_026_3101_1ea2"} -->

Modern ovens are the result of centuries of investments in new and improved capital, refined designs, better materials, and more effective production technologies. We take this long and complex history for granted. But, this historical production cycle has led to the modern appliances that now are available in our neighborhood stores. The same is true for everything we can buy: every good is a refined piece of nature that was created for a single purpose: to satisfy our wants as consumers.

<!-- {"id": "05_027_45c4_e90e"} -->

All of those efforts that create materials, tools, machines, etc., are investments in capital that enhance production and allow us to satisfy an ever greater variety of wants more effectively. Together, all this capital is arranged into a structure of production, that spans the whole economy. This capital structure allows us to effectively create a multitude of different goods that satisfy consumer wants.

<!-- {"id": "05_028_3131_68b7"} -->

This capital, used in different combinations (such as the oven made from rocks and the fire), allows society to produce distinct goods and services. We refer to all this capital as the *capital structure* of the economy. This structure, as well as everything it comprises, was *created*. The production of new capital adds to the structure by adding or improving productive capabilities. Maintenance investments extend the existing usefulness of the capital. Divestments and reallocations shift capital to the production of other goods, refining, adjusting, and changing the structure and thus the productive capability of the economy. The people who undertake the actions and take on the risks involved with these continuous changes of the capital structure we call "entrepreneurs".

### The Role of the Entrepreneur

<!-- {"id": "05_029_297b_ce4b"} -->

The business of entrepreneurs is to create our future. They do this by creating new goods or refining and improving production. In both cases, they bring about changes to the capital structure by either changing the use of existing capital or creating new capital. The aim in both cases is to create more value for consumers. If they are successful entreprenedurs get paid in *profits*. However, *time* and *risk* play an important role in this process.
